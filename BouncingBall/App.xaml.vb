...
NotInheritable Class App
    ...
    Protected Overrides Async Sub OnLaunched(args As Windows.ApplicationModel.Activation.LaunchActivatedEventArgs)
        ...
        If rootFrame Is Nothing Then
            ...
            rootFrame = New Frame()
            BouncingBall.Common.SuspensionManager.RegisterFrame(rootFrame, "appFrame")
            If args.PreviousExecutionState = ApplicationExecutionState.Terminated Then
                ' TODO: Load state from previously suspended application
                Await BouncingBall.Common.SuspensionManager.RestoreAsync()
            End If
    ...
    Private Async Sub OnSuspending(sender As Object, e As SuspendingEventArgs) Handles Me.Suspending
        ...
        Await BouncingBall.Common.SuspensionManager.SaveAsync()
        deferral.Complete()
    End Sub
